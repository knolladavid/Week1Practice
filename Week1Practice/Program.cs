...
namespace Week1Practice
{
    class Program
    {
        public static void Main(string[] args)
        {
            ...
            Console.WriteLine("My product list has " + productsList.Length + " in it.");
            ...
            Console.WriteLine("The product of 5 and 10 is " + RealMultiply(5, 10));
            Console.WriteLine("The product of 2 and " + myAge + " is " + RealMultiply(2, myAge));
        ...
        {
            //return a greeting using name param
            return "Hello " + name;
        }
        ...
        static void SuperLoop(int startNum, int endNum, int increment)
        {
            ...
            //print how many times the function looped
        ...
        static void LoopThis(int startNum, int endNum)
        {
            ...
            //print the numbers in the loop on one line
        ...
        private static void DoubleIt(int number)
        {
